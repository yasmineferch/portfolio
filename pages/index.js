  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          ...
          <div className="text-center p-10 py-10">
            <h2 className="text-5xl py-2 text-teal-600 font-medium dark:text-teal-400 md:text-6xl">
              yassmine ferchichi            </h2>
            <h3 className="text-2xl py-2 dark:text-white md:text-3xl">
              Developer Student.
            </h3>
            <p className="text-md py-5 leading-8 text-gray-800 dark:text-gray-200 max-w-xl mx-auto md:text-xl">
              Enthusiastic, focused and motivated junior developer with some experience. Good in
              problems solving. Excellent communication skills - both verbal and
              writes. Flexible and adaptable to the demands of changing work environments. A perfect leader.
            </p>
            <div className="text-5xl flex justify-center gap-16 py-3 text-gray-600 dark:text-gray-400">
              <a href="https://www.instagram.com/_yasmminee_/" >
                <AiFillInstagram />
              </a>
              <a href="https://www.linkedin.com/in/yasmine-ferchichi-705b17326/" >
                <AiFillLinkedin />
              </a>
              <a href=" https://github.com/yasmineferch" >
                <AiFillGithub />
              </a>
            </div>
        ...
        <section>
          ...
          <div className="lg:flex gap-10">
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1">
              ...
              <p className="text-gray-800 py-1">Angular Js</p>
        ...
        <section>
          <h4 className="py-4 text-teal-600">footer </h4>
        </section>
      </main>
    </div>
  );
